...
test_that("dgCMatrix <==> SVT_SparseArray coercions", {
    ...
    expect_identical(as(m0, "SVT_SparseArray"), svt)
    expect_identical(as(dgcm0, "SparseArray"), svt)
    expect_identical(as(m0, "SparseArray"), svt)
    ...
    expect_identical(as(m, "SVT_SparseArray"), svt)
    expect_identical(as(dgcm, "SparseArray"), svt)
    expect_identical(as(m, "SparseArray"), svt)
