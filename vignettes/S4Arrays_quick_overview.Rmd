...
arrays in R. The package is not intended to be used directly by the
end user.

# The Array virtual class

At the center of this foundation is the Array virtual class with no slots,
whose purpose is to be extended by other S4 classes that wish to implement
